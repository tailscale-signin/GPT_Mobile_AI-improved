...
An enhanced, high-performance, and feature-rich Android client for Large Language Models (LLMs), autonomous tool calling (MCP), on-device Qualcomm Snapdragon NPU acceleration, and local AI execution.

> **Fork Overview**: This version is a modernized, high-performance fork of [GPT_Mobile_AI](https://github.com/chungjungsoo/GPT_Mobile). It delivers a significantly smoother user experience, autonomous agent tools (MCP), on-device privacy AI with adaptive hardware acceleration (Qualcomm Hexagon NPU / GPU / CPU), real-time in-chat hardware diagnostics, background execution persistence, multi-key credential failover, encrypted backup vaults, and major battery and performance improvements.
...
### 3. 🚀 Qualcomm AI Engine Direct (QNN) & On-Device Hexagon NPU Acceleration
...
### 4. 🌙 Resilient Background & Screen-Off Execution
...
### 5. 🔑 Multi-Key Round-Robin Rotation, Auto-Failover & High-Demand Retry
...
### 6. 🎛️ Dedicated AI Platforms Hub & Interactive Model Sorting
...
### 7. 🔀 OpenRouter Advanced Routing & Reasoning Options
...
### 8. 🔒 High-Performance Local AI (LiteRT-LM & Ollama)
...
### 9. ⭐ Rich Favorites Management & Custom Categorization
...
### 10. 🛡️ Rolling Context Window Compactor (No Overflow Crashes)
...
### 11. 🔐 Keystore Encryption & Encrypted Vault Backups
...
### 12. 🗄️ Instant Search & Robust Database (`ChatDatabaseV2`)
...
### 13. 📉 Up to 60% Smaller App Download Size
...
| **Local Inference Engine** | Basic / Limited | ✅ LiteRT-LM (Qualcomm NPU/GPU/CPU), thermal governor, warm engine retention |
...
- **Local / Self-Hosted**: Qualcomm Hexagon NPU & LiteRT on-device LLMs (NPU/GPU/CPU accelerated), Ollama (custom IP and port).
