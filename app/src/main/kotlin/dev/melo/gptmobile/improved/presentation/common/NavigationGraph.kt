...
import dev.melo.gptmobile.improved.presentation.ui.chat.ChatScreen
import dev.melo.gptmobile.improved.presentation.ui.chat.ChatViewModel
import dev.melo.gptmobile.improved.presentation.ui.home.HomeScreen
import dev.melo.gptmobile.improved.presentation.ui.mcp.McpMarketplaceScreen
import dev.melo.gptmobile.improved.presentation.ui.migrate.MigrateScreen
import dev.melo.gptmobile.improved.presentation.ui.migrate.MigrateViewModel
import dev.melo.gptmobile.improved.presentation.ui.setting.AboutScreen
import dev.melo.gptmobile.improved.presentation.ui.setting.AddPlatformScreen
import dev.melo.gptmobile.improved.presentation.ui.setting.LicenseScreen
import dev.melo.gptmobile.improved.presentation.ui.setting.LocalModelsScreen
import dev.melo.gptmobile.improved.presentation.ui.setting.PlatformSettingScreen
import dev.melo.gptmobile.improved.presentation.ui.setting.SettingScreen
import dev.melo.gptmobile.improved.presentation.ui.setting.SettingViewModelV2
import dev.melo.gptmobile.improved.presentation.ui.setting.ToolConnectionEditorScreen
import dev.melo.gptmobile.improved.presentation.ui.setting.ToolConnectionsScreen
import dev.melo.gptmobile.improved.presentation.ui.setting.ToolConnectionsViewModel
import dev.melo.gptmobile.improved.presentation.ui.setup.SetupCompleteScreen
import dev.melo.gptmobile.improved.presentation.ui.setup.SetupPlatformListScreen
import dev.melo.gptmobile.improved.presentation.ui.setup.SetupPlatformTypeScreen
import dev.melo.gptmobile.improved.presentation.ui.setup.SetupPlatformWizardScreen
import dev.melo.gptmobile.improved.presentation.ui.setup.SetupViewModelV2
import dev.melo.gptmobile.improved.presentation.ui.startscreen.StartScreen
...
fun NavGraphBuilder.migrationScreenNavigation(navController: NavHostController) {
    composable(Route.MIGRATE_V2) {
        val migrateViewModel: MigrateViewModel = hiltViewModel()
        MigrateScreen(
            onNavigateBack = {
...
fun NavGraphBuilder.chatScreenNavigation(navController: NavHostController) {
    composable(
        Route.CHAT_ROOM,
        arguments = listOf(
            navArgument("chatRoomId") { type = NavType.IntType; defaultValue = 0 },
