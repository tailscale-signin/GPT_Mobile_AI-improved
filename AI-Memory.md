...
- **Build/release:** Gradle Kotlin DSL, R8/resource shrinking, ABI splits plus universal APK, and Room schema export (`app/schemas/`). Official release `v0.8.9` (branch `release-v0.8.9` and tag `v0.8.9-pre.6c124dd`).
