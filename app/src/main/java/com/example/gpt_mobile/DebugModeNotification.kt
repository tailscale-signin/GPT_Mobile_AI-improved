@file:Suppress("ktlint:standard:package-name") // Preserve the legacy receiver package.
...
object DebugModeNotification {
    ...
    fun showTelemetryNotification(context: Context, eventCount: Int) {
        ...
        postNotification(context, NOTIFICATION_ID + 1, notification)
    }
    ...
    fun showErrorNotification(context: Context, error: String) {
        ...
        postNotification(context, NOTIFICATION_ID + 2, notification)
    }
    ...
    private fun postNotification(context: Context, id: Int, notification: Notification) {
        ...
        try {
            ...
            // Permission may have been revoked between the check and posting.
        }
    }
