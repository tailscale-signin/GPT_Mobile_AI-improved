...
fun MaxToolCallsSetting(
    ...
    SettingItem(
        ...
        description = if (maxToolCalls == Int.MAX_VALUE) stringResource(R.string.unlimited) else maxToolCalls.toString(),
        enabled = enabled,
...
private fun MaxToolCallsDialog(
    ...
    AlertDialog(
            ...
            Column {
                ...
                OutlinedTextField(
                    ...
                    supportingText = {
                        Text(
                            stringResource(
                                if (isValid) R.string.maximum_tool_calls_blank_hint else R.string.maximum_tool_calls_invalid
                            )
                        )
                    }
                )
        ...
        confirmButton = {
            TextButton(
                enabled = isValid,
                onClick = { onConfirmRequest(if (isUnlimited) Int.MAX_VALUE else checkNotNull(parsedValue)) }
            ) {
