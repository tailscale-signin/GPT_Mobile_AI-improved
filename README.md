...
> **Fork Overview**: This version is a modernized, high-performance fork of [GPT_Mobile_AI](https://github.com/chungjungsoo/GPT_Mobile). It delivers a significantly smoother user experience, autonomous agent tools (MCP), on-device privacy AI with adaptive hardware acceleration (Qualcomm Hexagon NPU / GPU / CPU), real-time in-chat hardware diagnostics, background execution persistence, multi-key credential failover, encrypted backup vaults, local document RAG, sandboxed interactive artifacts, voice session coordination, and major battery and performance improvements.
...
### 5. 🚀 Qualcomm AI Engine Direct (QNN) & On-Device Hexagon NPU Acceleration
...
### 6. 🌙 Resilient Background & Screen-Off Execution
...
### 7. 🔑 Multi-Key Round-Robin Rotation, Auto-Failover & High-Demand Retry
...
### 8. 🎛️ Dedicated AI Platforms Hub & Interactive Model Sorting
...
### 9. 🔀 OpenRouter Advanced Routing & Reasoning Options
...
### 10. 🔒 High-Performance Local AI (LiteRT-LM & Ollama)
...
### 11. ⭐ Rich Favorites Management & Custom Categorization
...
### 12. 🛡️ Rolling Context Window Compactor (No Overflow Crashes)
...
### 13. 🔐 Keystore Encryption & Encrypted Vault Backups
...
### 14. 🗄️ Instant Search & Robust Database (`ChatDatabaseV2`)
...
### 15. 📉 Up to 60% Smaller App Download Size
