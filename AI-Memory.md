...
- `app/src/main/kotlin/dev/chungjungsoo/gptmobile/presentation/ui/setting/PlatformSettingDialogs.kt` — Modal configuration dialogs for platform settings (Ollama advanced options, OpenRouter routing, API tokens, temperature, topP, topK, accelerator, maxTokens, system prompt, Gemini safety, delete platform).
