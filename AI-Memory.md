...
- `README.md` — Project documentation with features overview, tech stack, build instructions, and license info. **Updated:** Streamlined for clarity and professionalism (removed excessive emoji/marketing language).
- `CONTRIBUTING.md`, `CODE_OF_CONDUCT.md`, `LICENSE` — Product and contributor documentation.
