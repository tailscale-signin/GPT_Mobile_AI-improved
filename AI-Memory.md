...
- `app/src/main/kotlin/dev/chungjungsoo/gptmobile/presentation/ui/setting/PlatformSettingDialogs.kt` — Configuration dialogs for platform settings, cleanly maintaining single implementations of all dialogs including `OllamaAdvancedSettingsDialog` and `OpenRouterAdvancedSettingsDialog`.
